...
class TestSimGpioSbus(unittest.TestCase):
    def setUp(self):
        cocotb_compile_and_run(sim_files=[os.path.join(os.path.dirname(__file__), 'test_SimGpio_sbus.v')], sim_bus='basil.utils.sim.BasilSbusDriver')
