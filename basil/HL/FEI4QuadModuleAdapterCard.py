...
class FEI4QuadModuleAdapterCard(AdcMax1239, DacDs4424, DacMax5380, Eeprom24Lc128, Fei4Dcs):
    ...
    # Channel mappings
    _ch_map = {
        "CH1": {"DACV": {"channel": 0xF8}, "ADCV": {"channel": 0}, "ADCI": {"channel": 1}, "NTC": {"channel": 8}},
        "CH2": {"DACV": {"channel": 0xF9}, "ADCV": {"channel": 2}, "ADCI": {"channel": 3}, "NTC": {"channel": 9}},
        "CH3": {"DACV": {"channel": 0xFA}, "ADCV": {"channel": 4}, "ADCI": {"channel": 5}, "NTC": {"channel": 10}},
        "CH4": {"DACV": {"channel": 0xFB}, "ADCV": {"channel": 6}, "ADCI": {"channel": 7}, "NTC": {"channel": 11}},
    }
