...
public:
	...
	float		GetFloat(t_Str szKey, t_Str szSection = t_Str(""), float def_val = 0);
				// GetInt: Return the value as an int
	int			GetInt(t_Str szKey, t_Str szSection = t_Str(""), int def_val = 0);
				// GetBool: Return the value as a bool
	bool		GetBool(t_Str szKey, t_Str szSection = t_Str(""), bool def_val = false);
