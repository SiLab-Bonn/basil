...
public:
    ...
    void retranslateUi(QMainWindow *MainForm)
    {
        ...
        addLine->setText(QApplication::translate("MainForm", "0x0000", 0));
        writeBtn->setText(QApplication::translate("MainForm", "Write", 0));
        readBtn->setText(QApplication::translate("MainForm", "Read", 0));
        label->setText(QApplication::translate("MainForm", "Address", 0));
